...
summary: "El paquete [npsp](https://rubenfcasal.github.io/npsp) proporciona herramientas para el
análisis no paramétrico de datos geoestadísticos en R.
...
La función genérica `kriging.np` permite obtener predicciones mediante
...
```{r kriging}
krig.grid0 <- kriging.np(geom0, ngrid = c(96, 96)) # 9216 predicciones
