...
summary: "Introducción a la escritura de libros con el paquete `bookdown`.
Una versión más reciente de este post está disponible en formato [libro](https://rubenfcasal.github.io/bookdown_intro)."
output:
  html_document:
    toc: true
    toc_float: true
