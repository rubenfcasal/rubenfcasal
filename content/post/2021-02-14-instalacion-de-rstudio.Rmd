...
Buscar la versión actualizada de RStudio en [Download RStudio](https://rstudio.com/products/rstudio/download/#download),
en este caso emplearemos "https://download1.rstudio.org/desktop/bionic/amd64/rstudio-1.2.5033-amd64.deb"
...
Si mo se dispone de un entorno gráfico puede ser recomendable instalar RStudio Server como se describe en [este post](#rstudio-server).
