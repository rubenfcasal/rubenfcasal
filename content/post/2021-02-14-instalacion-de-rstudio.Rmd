---
title: Instalación y configuración de RStudio Desktop (actualizado)
...
Por ese motivo acostumbro a modificar los archivos de configuración (en el directorio *C:\\Program Files\\RStudio\\resources\\app\\R* en Windows y 
*/Applications/RStudio.app/Contents/Resources/R* en Linux), que normalmente habrá que editar como administrador.
...
Para utilizar el dispositivo gráfico de R habría que modificar las siguientes líneas de *Tools.R*:
...
Para utilizar en su lugar el navegador del equipo habría que comentar las siguientes líneas de *Options.R*:
