---
title: Ayuda y recursos para el aprendizaje de R
...
A continuación se muestran algunos recursos que considero que pueden ser útiles para el aprendizaje de R y la obtención de ayuda... (página en preparación..., actualizado el `r Sys.Date()`).
