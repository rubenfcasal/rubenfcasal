...
abstract: "El paquete `geoR` proporciona herramientas para el
...
emplear también la rutina `sm.variogram` del paquete `sm`. Esta rutina
...
```{r }
pred.grid <- expand.grid(x = seq(0, 1, l = 51), y =  seq(0, 1, l = 51)) #rejilla regular 51x51 en cuadrado unidad
