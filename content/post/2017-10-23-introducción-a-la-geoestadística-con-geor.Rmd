...
date: '2017-10-23'
slug: introduccion-a-la-geoestadistica-con-geor
categories:
  - Documentos
  - Estadística
tags:
  ...
  - Regresión
  - Paquetes
summary: "En este post se ilustran algunas de las capacidades del paquete `geoR` para el análisis de datos geoestadísticos en `R`
  (otra alternativa es el paquete [`gstat`](http://r-spatial.github.io/gstat)...)."
output:
  blogdown::html_page:
    toc: true  
---
