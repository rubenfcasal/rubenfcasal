...
Otra alternativa sería instalar [Microsoft R Open](https://mran.revolutionanalytics.com/open) con [MKL](https://mran.revolutionanalytics.com/documents/rro/multithread), como se describe en [esta sección](#ropen).

Antes de nada, puede ser recomendable crear un directorio donde descargar archivos (si se instala RStudio, Microsoft R Open, Intel MKL o se compila R desde el código fuente):
